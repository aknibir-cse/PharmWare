...
public class Login extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        case R.id.sign_in_button: {
            ...
            System.out.println("Firebase Initial Response"+currentUser);
            if (currentUser != null)
                checkUserExist();
            else
                signIn();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (result.isSuccess()) {
                ...
                System.out.println("Acoount Registered"+account);
    ...
    public void updateUI(boolean ans) {
        if (ans) {
            Intent i = new Intent(this, com.pharmware.epharma.MainActivity.class);
            finish();
            startActivity(i);
        }
    }
            ...
            du.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.hasChild(uid)) {
                        ...
                        Intent i = new Intent(Login.this, com.pharmware.epharma.Register.class);
                        finish();
                        startActivity(i);
                    }
                }
