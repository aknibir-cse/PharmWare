...
public class MyAdapter extends RecyclerView.Adapter<com.pharmware.epharma.MyViewHolder> implements Filterable {

    Context c;

    String uid;
    ArrayList<com.pharmware.epharma.Model> models, filterList;
    DatabaseReference db;
    private FirebaseAuth mAuth;
    com.pharmware.epharma.CustomFilter filter;

    public MyAdapter(Context c, ArrayList<com.pharmware.epharma.Model> models) {
    ...
    @Override
    public com.pharmware.epharma.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(c).inflate(R.layout.card_layout, parent, false);
        return new com.pharmware.epharma.MyViewHolder(v);
    }
    ...
    public Filter getFilter() {
        ...
        if (filter == null) {
            filter = new com.pharmware.epharma.CustomFilter(filterList, this);
        }
        return filter;
    }
}
