...
public class MyAdapterTrans extends RecyclerView.Adapter<MyViewHolderTrans> implements Filterable {
    ...
    String uid;
    ArrayList<com.pharmware.epharma.Modeltrans> models, filterList;
    DatabaseReference db;
    private FirebaseAuth mAuth;
    com.pharmware.epharma.CustomFilterTrans filter;

    public MyAdapterTrans(Context c, ArrayList<com.pharmware.epharma.Modeltrans> models) {
    ...
    public void onBindViewHolder(final MyViewHolderTrans holder, final int position) {
        ...
        holder.cv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(c, com.pharmware.epharma.Bill.class);
    ...
    public Filter getFilter() {
        ...
        if (filter == null) {
            filter = new com.pharmware.epharma.CustomFilterTrans(filterList, this);
        }
        return filter;
    }
}
