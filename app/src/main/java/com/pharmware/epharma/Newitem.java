...
public class Newitem extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        emrp.setFilters(new InputFilter[] { new com.pharmware.epharma.DecimalDigitsInputFilter(2) });
        esp.setFilters(new InputFilter[] { new com.pharmware.epharma.DecimalDigitsInputFilter(2) });
        ecp.setFilters(new InputFilter[] { new com.pharmware.epharma.DecimalDigitsInputFilter(2) });
    ...
    public void addInfo(View v) {
        ...
        if (validate()) {
            ...
            com.pharmware.epharma.Model m = new com.pharmware.epharma.Model(siname, sbatchNo, sqty, sexpDate, smrp, ssp, scName, scode, scp, sdesc, k, sunit);
