...
public class Trans extends AppCompatActivity implements View.OnClickListener {
    ...
    com.pharmware.epharma.AutoAdapter adapter;
    com.pharmware.epharma.AutoCustAdapter autoCustAdapter;
    com.pharmware.epharma.ListAdapter listadapter;
    ArrayList<com.pharmware.epharma.Model> models = new ArrayList<>();
    TextInputLayout date, pt, doc, age;
    EditText edate, ept, edoc, eage, due;
    private int mYear, mMonth, mDay;
    ArrayList<com.pharmware.epharma.ListModel> listmodel = new ArrayList<>();
    ArrayList<com.pharmware.epharma.Modelcustomer> modelcustomers = new ArrayList<>();
    ListView lv;
    Button btn, custbtn;
    static Button gen;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
                    ...
                    if (custValidate()) {
                        ...
                        alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent i = new Intent(getApplicationContext(), com.pharmware.epharma.Bill.class);
                                i.putExtra("key", k);
                                startActivity(i);
                                finish();
                            }
        ...
        db.child("Items").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    com.pharmware.epharma.Model model = ds.getValue(com.pharmware.epharma.Model.class);
                    models.add(model);
                }

                act.setThreshold(1);
                adapter = new com.pharmware.epharma.AutoAdapter(Trans.this, R.layout.m_trans, R.id.item_name, models);
        ...
        dbc.child("Person").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    com.pharmware.epharma.Modelcustomer model = ds.getValue(com.pharmware.epharma.Modelcustomer.class);
                    modelcustomers.add(model);
                }

                act2 = (AutoCompleteTextView) findViewById(R.id.actcust);
                act2.setThreshold(1);
                autoCustAdapter = new com.pharmware.epharma.AutoCustAdapter(Trans.this, R.layout.m_trans, R.id.item_name, modelcustomers);
        ...
        listadapter = new com.pharmware.epharma.ListAdapter(Trans.this, R.layout.list_items, listmodel);
        lv.setAdapter(listadapter);
        com.pharmware.epharma.Utility.setListViewHeightBasedOnChildren(lv);
    }
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (!qt.equals("") && !qt.equals("0")) {
                            ...
                            if (Integer.parseInt(qt) <= Integer.parseInt(o)) {
                                ...
                                com.pharmware.epharma.ListModel list = new com.pharmware.epharma.ListModel(item, mrp, qt, amount, batch, t, k, o, u);
                                listmodel.add(list);
